/*
 * SchoolsScreen.java	v0.5.0	2016-01-13
 */
...
public class SchoolsScreen extends Screen {
    ...
    public void resume() {
		...
		DataObject<XMLDatastrategy.MapRow> mapTable, schools;
		...
		schools = mapTable.search(new Comparable<XMLDatastrategy.MapRow>() {
			@Override
			public int compareTo(XMLDatastrategy.MapRow o) {
				String requiredType, comparedType;

				requiredType = "academic_dept";
		...
		for (DataObject dataObject : schools) {
